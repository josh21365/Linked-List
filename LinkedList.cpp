...
void LinkedList::Append(Bid bid) {
    ...
    // if the list is empty, head points to new node
    if (head == nullptr) {
        head = newNode;
    }
    // else loop over the nodes until the end
    else {
        // while loop over each node, find the last node
...
void LinkedList::PrintList() {
    ...
    while (current != nullptr)
    {
        ...
        cout << "ID: " << current->bid.bidId << endl;
...
void LinkedList::Remove(string bidId) {
    ...
    while (current != nullptr)
    {
        ...
        if (current->bid.bidId == bidId)
        {
            ...
            if (previous == nullptr)
            {
                // head now points to next node
                head = current->next;
            }
            else
            {
                // make previous node point beyond current node
            ...
            // return since we found and removed the bid
            return;
        }
